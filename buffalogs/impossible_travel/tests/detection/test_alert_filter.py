...
class TestAlertFilter(TestCase):
    ...
    def setUpTestData(cls):
        ...
        Alert.objects.create(
            ...
            description=(
                "Login from new country for User: Aisha Delgado, at: "
                "2025-01-20T08:01:00.000Z, from: Japan"
            ),
            login_raw_data={
                "id": 2,
                "ip": "5.6.7.8",
                ...
                "lon": 137.062,
                "agent": (
                    "Mozilla/5.0 (Linux; Android 13; SM-G998U) "
    ...
    def test_match_filters_default_config_values(self):
        ...
        self.assertEqual(
            ...
            settings.CERTEGO_BUFFALOGS_ALLOWED_COUNTRIES,
        )
